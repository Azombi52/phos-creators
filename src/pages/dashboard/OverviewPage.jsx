...
import {
  TrendingUp, DollarSign, Eye, Users, Star,
  ArrowUpRight, ArrowRight, MessageSquare, CheckCircle
} from 'lucide-react'
...
const projects = [
  { client: 'Solaris Energy', initials: 'SE', color: 'from-amber-400 to-orange-500', package: 'Brand Identity Package', amount: 1200, status: 'in_progress', milestone: 'Milestone 2 of 4', due: 'Due Apr 2' },
  { client: 'Kente Digital', initials: 'KD', color: 'from-emerald-400 to-teal-600', package: 'Monthly Retainer', amount: 800, status: 'awaiting_review', milestone: 'Deliverable submitted', due: 'Awaiting approval' },
  { client: 'LearnAfrica', initials: 'LA', color: 'from-blue-400 to-blue-600', package: 'Brand Audit', amount: 250, status: 'completed', milestone: 'All milestones complete', due: 'Paid Mar 15' },
  { client: 'Pula Fintech', initials: 'PF', color: 'from-purple-400 to-purple-700', package: 'Logo Design', amount: 350, status: 'new', milestone: 'Brief received', due: 'Start by Apr 5' },
]
...
export default function OverviewPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-xl font-bold text-ink-900">Good morning, {firstName} 👋</h1>
        <p className="text-sm text-ink-500 mt-0.5">Here's what's happening with your business today.</p>
      </div>
          ...
          <div className="flex items-end gap-2 h-32">
            {earnings.map(({ month, amount }) => (
              <div key={month} className="flex-1 flex flex-col items-center gap-1.5">
                <div
                  className={`w-full rounded-t-md ${month === 'Mar' ? 'bg-phos-600' : 'bg-ink-200'}`}
      ...
      <div className="bg-white rounded-xl border border-ink-200 overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-ink-100">
          ...
          <NavLink to="/dashboard/projects" className="text-sm text-phos-600 font-semibold hover:underline flex items-center gap-1">
